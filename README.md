...
![Model Mondays](./docs/assets/misc/model-mondays-banner.png)
...
- When: Feb 23, 2026 at 1:30pm ET
- Where: [REGISTER FOR LIVESTREAM](https://aka.ms/MM/feb23g) 
- Join us as we go **Hands-on with Claude in Microsoft Foundry** with our featured spotlight on Anthropic.
...
| 11 | [Mar 02](https://aka.ms/model-mondays/rsvp) | [Mar 06](docs/foundry-fridays/2026-03-06-s03-e11-control-plane-ama.md) | | Sebastian Kohlmeier | [Observability in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/control-plane/overview?view=foundry): Manage multi-agent fleets at enterprise scale with unified observability |
| 12 | [Mar 09](https://aka.ms/model-mondays/rsvp) | [Mar 13](docs/foundry-fridays/2026-03-13-s03-e12-dev-experience-ama.md) | | Leo Yao | [AI Toolkit](https://learn.microsoft.com/en-us/windows/ai/toolkit/): Build, evaluate, and deploy AI solutions directly from VS Code |
...
![CTA](./docs/assets/misc/model-mondays-s3.png)
...
![Contest](./docs/assets/misc/ignite25-agent-contest.png)
...
![CTA](./docs/assets/misc/3-cta.png)
